        ...
        <div
          ...
          className={`px-1 cursor-pointer ${
            selectedTab === index
              ...
              : "dark:text-gray-400 text-black font-bold"
          }`}
    ...
    <table className="w-full">
      <tbody>
        {cards.map((card, index) => (
          <tr key={card.name}>
            <td className="pl-4 pr-0 py-2">{index + 1}</td>
            ...
            <td className="pl-0 pr-4  py-2">
              <div>
                ...
                <div className="flex">
                  <p>{card.moneyRaised} Matic - Listing Time:</p>
                  <p className="ml-1">
        ...
        a 15.9155 15.9155 0 0 1 0 -31.831"
            ...
            <td className="px-1 py-2">
              <a href={card.link} className="text-green-500">
