...
import FinishDetails from "@/components/details/Auction/FinishDetails";
import TokenMetrics from "@/components/details/Auction/TokenMetrics";
...
import Cards2 from "@/components/details/Auction/Cards2";
import Button from "@/components/details/Auction/Button";
import ChartComponent from "@/components/details/Auction/PriceChart";
import SidePanel from "@/components/details/Auction/SidePanel";
...
const Auction = () => {
  ...
  console.log(decreasePriceCycle + "decreasePriceCycle");

  let purchaseTokenDecimalAuction = !isNaN(purchaseTokenDecimalsAuctionSoft)
    ? 18
    : purchaseTokenDecimalsAuctionSoft;

  console.log(purchaseTokenDecimalAuction + "purchaseTokenDecimalAuction");
