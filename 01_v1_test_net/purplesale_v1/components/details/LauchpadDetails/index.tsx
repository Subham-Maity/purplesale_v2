import AffiliateProgram from "@/components/details/LauchpadDetails/AffiliateProgram";
import Faq from "@/components/FAQ/Faq";
import FinishDetails from "@/components/details/LauchpadDetails/FinishDetails";
import TokenMetrics from "@/components/details/LauchpadDetails/TokenMetrics";
...
import Cards2 from "@/components/details/LauchpadDetails/Cards2";
import Button from "@/components/details/LauchpadDetails/Button";
import SidePanel from "@/components/details/LauchpadDetails/SidePanel";
...
const SubComponent = () => {
  ...
  console.log(totalSuppliesAuction + "totalSuppliesAuction");
  ...
  console.log(softCapPresale + "softCapPresale");
  ...
  console.log(purchaseTokenDecimalPresale, "purchaseTokenDecimalPresale");
  ...
  console.log(purchaseTokenDecimals, "purchaseTokenDecimals");
  const maximumBuy =
  ...
  return (
    <div className="lg:flex">
      <div className="lg:flex flex-col ">
        <div className="flex-col ml-4 md:ml-64 lg:ml-96">
          <FinishDetails
        ...
        <div className="w-[380px] lg:w-[640px] ml-4 md:ml-64 lg:ml-96">
