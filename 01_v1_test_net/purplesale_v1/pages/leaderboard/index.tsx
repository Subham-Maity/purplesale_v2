...
export function SubBox({ title, number }: SubBoxProps) {
  return (
    <div className="flex flex-col items-center p-3 w-[360px] lg:w-[1060px]">
...
const LeaderboardPage: React.FC<any> = ({ weeksData }) => {
  ...
  //Sum of the presale money raised + auction money raised + fair money raised + subscription money raised

  //TOTAL SUCCESS THIS WEEK -> Sum of where money raised is greater than softcap/hardcap according to the type of launchpad
  ...
  return (
    <div className="flex justify-center mt-8 ">
      <div className="w-[360px] lg:w-[1060px] dark:bg-[#242525] bg-stone-50 rounded-md">
