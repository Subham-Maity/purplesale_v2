...
import Bottom from "@/components/details/Multichain/Avalanche/PinkLock/record/Bottom";
import MiddleBox from "@/components/details/Multichain/Avalanche/PinkLock/record/Middle";
import TopBox from "@/components/details/Multichain/Avalanche/PinkLock/record/Top";
...
import Button from "@/components/details/Multichain/Avalanche/PinkLock/record/Button";
interface Props {
  title: string;
}
const Record = () => {
