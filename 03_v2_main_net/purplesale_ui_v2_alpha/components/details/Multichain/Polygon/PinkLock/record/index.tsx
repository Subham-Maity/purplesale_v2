...
import Bottom from "@/components/details/Multichain/Polygon/PinkLock/record/Bottom";
import MiddleBox from "@/components/details/Multichain/Polygon/PinkLock/record/Middle";
import TopBox from "@/components/details/Multichain/Polygon/PinkLock/record/Top";
...
import Button from "@/components/details/Multichain/Polygon/PinkLock/record/Button";
interface Props {
  title: string;
}
const Record = () => {
  ...
  useEffect(() => {
    axios
      .get(`/fetch-data-pinklock/Polygon`)
      .then((response: any) => {
