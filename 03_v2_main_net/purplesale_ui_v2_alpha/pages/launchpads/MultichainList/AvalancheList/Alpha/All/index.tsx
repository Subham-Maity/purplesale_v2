...
import PreSaleCards from "@/components/Cards/Avalanche/Alpha/Launchpads/PreSaleCards";
import FairLaunchCards from "@/components/Cards/Avalanche/Alpha/Launchpads/FairLaunchCards";
import DutchAuctionCards from "@/components/Cards/Avalanche/Alpha/Launchpads/dutchAuctionCards";
import SubscriptionCards from "@/components/Cards/Avalanche/Alpha/Launchpads/SubscriptionCards";
...
const All = () => {
  ...
  const fetchWeb2DataPresale = async () => {
    try {
      const response = await axios.get("/Alpha/presale-fetch-data/Avalanche");
  ...
  const fetchWeb2DataFairLaunch = async () => {
    try {
      const response = await axios.get(
        "/Alpha/fairLaunch-fetch-data/Avalanche",
      );
  ...
  const fetchWeb2DataAuction = async () => {
    try {
      const response = await axios.get(
        "/Alpha/dutchAuction-fetch-data/Avalanche",
      );
  ...
  const fetchWeb2DataSubscription = async () => {
    try {
      const response = await axios.get(
        "/Alpha/Subscription-fetch-data/Avalanche",
      );
  ...
  //If purchaseToken address is not zero address then currency is purchaseToken's symbol else currency is AVAX
  //🚀 Presale
                ...
                {dataMainPresale.map((item: any, index: any) => {
                  ...
                  return (
                    <PreSaleCards
                      ...
                      currency={currencyPresale[index] || "AVAX"}
                ...
                {dataMainFair.map((item: any, index: any) => {
                  ...
                  return (
                    <FairLaunchCards
                      ...
                      currency={currencyFair[index] || "AVAX"}
                      bg={
                        matchingIndex !== -1
                ...
                {dataMainAuction.map((item: any, index: any) => {
                  ...
                  return (
                    <DutchAuctionCards
                      ...
                      currency={currencyAuction[index] || "AVAX"}
                      bg={
                        matchingIndex !== -1
