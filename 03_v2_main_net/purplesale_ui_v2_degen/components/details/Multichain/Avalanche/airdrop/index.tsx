...
import FinishDetails from "@/components/details/Multichain/Avalanche/airdrop/FinishDetails";
import Cards2 from "@/components/details/Multichain/Avalanche/airdrop/Cards2";
import BottomBox from "@/components/details/Multichain/Avalanche/airdrop/BottomBox";
import axios from "@/constants/axio";
import Button from "@/components/details/Multichain/Avalanche/airdrop/Button";
...
const Airdrop = () => {
  ...
  const fetchWeb2DataPrivSale = async () => {
    try {
      const response = await axios.get("/airDrop-fetch-data/Avalanche");
