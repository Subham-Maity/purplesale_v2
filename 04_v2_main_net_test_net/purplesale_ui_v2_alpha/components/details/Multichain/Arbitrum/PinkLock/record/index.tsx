...
import Bottom from "@/components/details/Multichain/Arbitrum/PinkLock/record/Bottom";
import MiddleBox from "@/components/details/Multichain/Arbitrum/PinkLock/record/Middle";
import TopBox from "@/components/details/Multichain/Arbitrum/PinkLock/record/Top";
...
import Button from "@/components/details/Multichain/Arbitrum/PinkLock/record/Button";
interface Props {
  title: string;
}
const Record = () => {
  ...
  useEffect(() => {
    axios
      .get(`/fetch-data-pinklock/Arbitrum`)
      .then((response: any) => {
