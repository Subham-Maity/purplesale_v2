...
import MultiSender from "@/pages/multi-sender/Multichain/Ethereum/section/AddYourAllocation";
import Finish from "@/pages/multi-sender/Multichain/Ethereum/section/Finish";
