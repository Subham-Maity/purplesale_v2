...
import FinishDetails from "@/components/details/Multichain/PolygonMumbai/FairLaunch/FinishDetails";
import TokenMetrics from "@/components/details/Multichain/PolygonMumbai/FairLaunch/TokenMetrics";
...
import Cards2 from "@/components/details/Multichain/PolygonMumbai/FairLaunch/Cards2";
import Button from "@/components/details/Multichain/PolygonMumbai/FairLaunch/Button";
import SidePanel from "@/components/details/Multichain/PolygonMumbai/FairLaunch/SidePanel";
      ...
      <div className="lg:flex flex-col ">
        <div className="flex-col ">
          <FinishDetails
            ...
            softCapCurrency={softCapHardCapCurrencyFair[dataIndex] || "MATIC"}
            currency={currencyFair[dataIndex] || "MATIC"}
      ...
      <div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 ">
          <Cards2
            ...
            currency={softCapHardCapCurrencyFair[dataIndex] || "MATIC"}
          />
        </div>
        <Button
