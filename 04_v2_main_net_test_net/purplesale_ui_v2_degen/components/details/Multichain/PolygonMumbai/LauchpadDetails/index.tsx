import AffiliateProgram from "@/components/details/Multichain/PolygonMumbai/LauchpadDetails/AffiliateProgram";
import Faq from "@/components/FAQ/Faq";
import FinishDetails from "@/components/details/Multichain/PolygonMumbai/LauchpadDetails/FinishDetails";
import TokenMetrics from "@/components/details/Multichain/PolygonMumbai/LauchpadDetails/TokenMetrics";
...
import Cards2 from "@/components/details/Multichain/PolygonMumbai/LauchpadDetails/Cards2";
import Button from "@/components/details/Multichain/PolygonMumbai/LauchpadDetails/Button";
import SidePanel from "@/components/details/Multichain/PolygonMumbai/LauchpadDetails/SidePanel";
...
const SubComponent = () => {
  ...
  const fetchWeb2DataPresale = async () => {
    try {
      const response = await axios.get("/presale-fetch-data/PolygonMumbai");
  ...
  const fetchWeb2DataFairLaunch = async () => {
    try {
      const response = await axios.get("/fairLaunch-fetch-data/PolygonMumbai");
  ...
  const fetchWeb2DataAuction = async () => {
    try {
      const response = await axios.get(
        "/dutchAuction-fetch-data/PolygonMumbai",
      );
  ...
  const fetchWeb2DataSubscription = async () => {
    try {
      const response = await axios.get(
        "/Subscription-fetch-data/PolygonMumbai",
      );
      ...
      <div className="lg:flex flex-col ">
        <div className="flex-col ">
          <FinishDetails
            ...
            currency={currencyPresale[dataIndex] || "MATIC"}
