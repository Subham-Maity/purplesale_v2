...
import FinishDetails from "@/components/details/Multichain/PolygonMumbai/PrivateSale/FinishDetails";
...
import Cards2 from "@/components/details/Multichain/PolygonMumbai/PrivateSale/Cards2";
import SidePanel from "@/components/details/Multichain/PolygonMumbai/PrivateSale/SidePanel";
import DisqusComments from "@/components/Disqus/Disqus";
import Button from "@/components/details/Multichain/PolygonMumbai/PrivateSale/Button";
...
const SubComponent = () => {
  ...
  const fetchWeb2DataPrivSale = async () => {
    try {
      const response = await axios.get("/privateSale-fetch-data/PolygonMumbai");
      ...
      <div className="lg:flex flex-col ">
        <div className="flex-col ">
          <FinishDetails
            ...
            currency={currencySub[dataIndex] || "MATIC"}
          />
