...
import FinishDetails from "@/components/details/Multichain/PolygonMumbai/airdrop/FinishDetails";
import Cards2 from "@/components/details/Multichain/PolygonMumbai/airdrop/Cards2";
import BottomBox from "@/components/details/Multichain/PolygonMumbai/airdrop/BottomBox";
import axios from "@/constants/axio";
import Button from "@/components/details/Multichain/PolygonMumbai/airdrop/Button";
...
const Airdrop = () => {
  ...
  const fetchWeb2DataPrivSale = async () => {
    try {
      const response = await axios.get("/airDrop-fetch-data/PolygonMumbai");
