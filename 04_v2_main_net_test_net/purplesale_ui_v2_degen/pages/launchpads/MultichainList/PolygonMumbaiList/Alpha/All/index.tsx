...
import PreSaleCards from "@/components/Cards/PolygonMumbai/Alpha/Launchpads/PreSaleCards";
import FairLaunchCards from "@/components/Cards/PolygonMumbai/Alpha/Launchpads/FairLaunchCards";
import DutchAuctionCards from "@/components/Cards/PolygonMumbai/Alpha/Launchpads/dutchAuctionCards";
import SubscriptionCards from "@/components/Cards/PolygonMumbai/Alpha/Launchpads/SubscriptionCards";
...
const All = () => {
  ...
  const fetchWeb2DataPresale = async () => {
    try {
      const response = await axios.get(
        "/Alpha/presale-fetch-data/PolygonMumbai",
      );
  ...
  const fetchWeb2DataFairLaunch = async () => {
    try {
      const response = await axios.get(
        "/Alpha/fairLaunch-fetch-data/PolygonMumbai",
      );
  ...
  const fetchWeb2DataAuction = async () => {
    try {
      const response = await axios.get(
        "/Alpha/dutchAuction-fetch-data/PolygonMumbai",
      );
  ...
  const fetchWeb2DataSubscription = async () => {
    try {
      const response = await axios.get(
        "/Alpha/Subscription-fetch-data/PolygonMumbai",
      );
