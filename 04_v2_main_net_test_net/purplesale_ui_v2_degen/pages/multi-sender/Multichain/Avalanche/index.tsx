...
import MultiSender from "@/pages/multi-sender/Multichain/Avalanche/section/AddYourAllocation";
import Finish from "@/pages/multi-sender/Multichain/Avalanche/section/Finish";
