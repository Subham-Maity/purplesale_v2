  ...
  return (
    <div className="flex flex-col mt-20 mb-4 justify-center items-center">
      <div className="max-w-screen-xl rounded-md px-6">
        <div>
          <ul className="flex flex-wrap -mb-px font-medium text-center bg-[#1f1f1f] text-md rounded-xl mb-10 text-gray-500 dark:text-gray-400">
            {tabs.map((tabName, index) => {
              ...
              return (
                <li className="mr-2" key={index}>
                  <Link
                    href="#"
                    className={`inline-flex w-[407px] h-[50px]  items-center justify-center p-4 ${
                      isActive
