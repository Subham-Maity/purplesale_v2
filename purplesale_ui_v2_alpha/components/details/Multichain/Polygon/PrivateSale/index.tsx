...
import FinishDetails from "@/components/details/Multichain/Polygon/PrivateSale/FinishDetails";
...
import Cards2 from "@/components/details/Multichain/Polygon/PrivateSale/Cards2";
import SidePanel from "@/components/details/Multichain/Polygon/PrivateSale/SidePanel";
import DisqusComments from "@/components/Disqus/Disqus";
import Button from "@/components/details/Multichain/Polygon/PrivateSale/Button";
...
const SubComponent = () => {
  ...
  const fetchWeb2DataPrivSale = async () => {
    try {
      const response = await axios.get("/privateSale-fetch-data/Polygon");
