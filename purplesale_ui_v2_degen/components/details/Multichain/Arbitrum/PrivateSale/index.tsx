...
import FinishDetails from "@/components/details/Multichain/Arbitrum/PrivateSale/FinishDetails";
...
import Cards2 from "@/components/details/Multichain/Arbitrum/PrivateSale/Cards2";
import SidePanel from "@/components/details/Multichain/Arbitrum/PrivateSale/SidePanel";
import DisqusComments from "@/components/Disqus/Disqus";
import Button from "@/components/details/Multichain/Arbitrum/PrivateSale/Button";
...
const SubComponent = () => {
  ...
  const fetchWeb2DataPrivSale = async () => {
    try {
      const response = await axios.get("/privateSale-fetch-data/Arbitrum");
