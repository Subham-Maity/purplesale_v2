...
import FinishDetails from "@/components/details/Multichain/Polygon/airdrop/FinishDetails";
import Cards2 from "@/components/details/Multichain/Polygon/airdrop/Cards2";
import BottomBox from "@/components/details/Multichain/Polygon/airdrop/BottomBox";
import axios from "@/constants/axio";
import Button from "@/components/details/Multichain/Polygon/airdrop/Button";
...
const Airdrop = () => {
  ...
  const fetchWeb2DataPrivSale = async () => {
    try {
      const response = await axios.get("/airDrop-fetch-data/Polygon");
