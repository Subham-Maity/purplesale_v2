...
import Bottom from "@/components/details/PinkLock/record/Bottom";
import MiddleBox from "@/components/details/PinkLock/record/Middle";
import TopBox from "@/components/details/PinkLock/record/Top";
...
import Button from "@/components/details/PinkLock/record/Button";
interface Props {
  title: string;
}
const Record = () => {
