...
import PreSaleCards from "@/components/Cards/Polygon/Alpha/Launchpads/PreSaleCards";
import FairLaunchCards from "@/components/Cards/Polygon/Alpha/Launchpads/FairLaunchCards";
import DutchAuctionCards from "@/components/Cards/Polygon/Alpha/Launchpads/dutchAuctionCards";
import SubscriptionCards from "@/components/Cards/Polygon/Alpha/Launchpads/SubscriptionCards";
...
const All = () => {
  ...
  const fetchWeb2DataPresale = async () => {
    try {
      const response = await axios.get("/Alpha/presale-fetch-data/Polygon");
  ...
  const fetchWeb2DataFairLaunch = async () => {
    try {
      const response = await axios.get("/Alpha/fairLaunch-fetch-data/Polygon");
  ...
  const fetchWeb2DataAuction = async () => {
    try {
      const response = await axios.get(
        "/Alpha/dutchAuction-fetch-data/Polygon",
      );
  ...
  const fetchWeb2DataSubscription = async () => {
    try {
      const response = await axios.get(
        "/Alpha/Subscription-fetch-data/Polygon",
      );
