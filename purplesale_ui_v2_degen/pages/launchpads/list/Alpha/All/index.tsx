...
import PreSaleCards from "@/components/Cards/Alpha/Launchpads/PreSaleCards";
import FairLaunchCards from "@/components/Cards/Alpha/Launchpads/FairLaunchCards";
import DutchAuctionCards from "@/components/Cards/Alpha/Launchpads/dutchAuctionCards";
import SubscriptionCards from "@/components/Cards/Alpha/Launchpads/SubscriptionCards";
...
const All = () => {
  ...
  const fetchWeb2DataPresale = async () => {
    try {
      const response = await axios.get("/Alpha/presale-fetch-data");
  ...
  const fetchWeb2DataFairLaunch = async () => {
    try {
      const response = await axios.get("/Alpha/fairLaunch-fetch-data");
  ...
  const fetchWeb2DataAuction = async () => {
    try {
      const response = await axios.get("/Alpha/dutchAuction-fetch-data");
  ...
  const fetchWeb2DataSubscription = async () => {
    try {
      const response = await axios.get("/Alpha/Subscription-fetch-data");
