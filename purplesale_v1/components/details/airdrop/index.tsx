...
import FinishDetails from "@/components/details/airdrop/FinishDetails";
import Cards2 from "@/components/details/airdrop/Cards2";
import BottomBox from "@/components/details/airdrop/BottomBox";
import axios from "@/constants/axio";
import Button from "@/components/details/airdrop/Button";
...
const Airdrop = () => {
  ...
  console.log(getAllocationString, "getAllocationString");
  ...
  console.log(getAllocation, getClaimedString, "getClaimedString");
            ...
            <div className="mt-4 flex justify-left mb-4 items-center">
              <div className="w-[370px] lg:w-[640px] md:w-[368px] dark:bg-[#242525] bg-stone-50 rounded-md p-6 ">
                <div className="flex justify-between">
                  <p className="ml-4 font-bold">Allocations</p>
                  <p></p>
                  <p></p>
                </div>
                {Address[dataIndex].map((allocation: any, index: any) => (
                  <BottomBox
                    ...
                    amount={
                      Amount[dataIndex][index] / 10 ** decimals[dataIndex]
                    }
                    symbol={symbol[dataIndex]}
                  />
                ))}
